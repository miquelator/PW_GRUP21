...
$app->get('/bigPhoto/{path}/{titol}/{created}/{likes}/{visits}/{user}/{id}', 'PracticaFinal\\Controller\\PhotoController::showPhoto');
...
$app->get('/edita_imatge/edita/{id}', 'PracticaFinal\\Controller\\PhotoController::editaImatgeForm');
