        ...
        if ($request->isMethod('POST')) {
            ...
            if ($this->validName($name) &&
                ...
                */
                ...
                $content = $app['twig']-> render('main_register.twig',array('error' => "",'link_activacio'=>"/activacio_link/".$id.">Clica per activar el teu usuari</a></p>")); //no envio res com a missatge d'error
